#include "AccuWeatherForecastParser.h"
...
std::string AccuWeatherForecastParser::GetURL() const 
{
    return "http://dataservice.accuweather.com/forecasts/v1/daily/5day/332120?apikey=E73cA2eAoUBJBCtEGvmSZamye4fl11ae&details=true";
}

std::vector<ForecastDayData> AccuWeatherForecastParser::Parse(std::istream& stream) const
{
    json data = json::parse(stream);
    return ::Parse(data);
}

std::vector<ForecastDayData> AccuWeatherForecastParser::Parse(const std::string& str) const
{
